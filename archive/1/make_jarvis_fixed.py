...
# Чистим старую папку, чтобы не было мусора
...
final class Logger {
    ...
    func write(_ message: String) {
        // Важно: вся строка в одном литерале, без разрывов
...
final class WebServer {
    ...
    private func handle(conn: NWConnection) {
        ...
        conn.receive(minimumIncompleteLength: 1, maximumLength: 65536) { [weak self] data, _, _, _ in
            ...
            // HTTP‑ответ одной строкой, без разрывов внутри литерала
...
if result.returncode != 0:
    ...
    print("✓ Build OK")
    binary_path = os.path.join(BASE, ".build/release/JarvisServer")
